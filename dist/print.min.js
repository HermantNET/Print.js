...
function collectStyles(element, params) {
  ...
  if (win.getComputedStyle) {
    ...
    // Styles including
    var targetStyles = ['border', 'box', 'break', 'text-decoration'];
...
/* harmony default export */ __webpack_exports__["a"] = ({
  print: function print(params, printFrame) {
    ...
    var printElement = typeof params.printable === 'string' ? document.getElementById(params.printable) : _typeof(params.printable) === 'object' ? params.printable : null;
...
function jsonToHTML(params) {
  ...
  for (var a = 0; a < properties.length; a++) {
    htmlData += '<div style="flex:1; padding:5px;' + params.gridHeaderStyle + '">' + __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__functions__["b" /* capitalizePrint */])(properties[a]['displayName'] || properties[a]) + '</div>';
  }
